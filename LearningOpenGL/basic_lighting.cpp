...
void basic_lighting()
{
	...
	Shader shader1("basic_lighting.vert", "basic_lighting.frag");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glUniform3f(glGetUniformLocation(shader1.ID, "objectColor"), 1.0f, 0.5f, 0.31f);
		glUniform3f(glGetUniformLocation(shader1.ID, "lightColor"), 1.0f, 1.0f, 1.0f);
		glUniform3fv(glGetUniformLocation(shader1.ID, "lightPos"), 1, &lightPos[0]);
