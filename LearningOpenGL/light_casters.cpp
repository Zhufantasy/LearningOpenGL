...
void light_casters()
{
	...
	Shader shader1("light_casters.vert", "light_casters.frag");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glUseProgram(shader1.ID);
		glUniform3fv(glGetUniformLocation(shader1.ID, "light.position"), 1, &camera.Position[0]);
		glUniform3fv(glGetUniformLocation(shader1.ID, "light.direction"), 1, &camera.Front[0]);
		glUniform1f(glGetUniformLocation(shader1.ID, "light.cutOff"), glm::cos(glm::radians(12.5f)));
		glUniform1f(glGetUniformLocation(shader1.ID, "light.outerCutOff"), glm::cos(glm::radians(17.5f)));
		glUniform3fv(glGetUniformLocation(shader1.ID, "viewPos"), 1, &camera.Position[0]);
		glUniform3f(glGetUniformLocation(shader1.ID, "light.ambient"), 0.1f, 0.1f, 0.1f);
		glUniform3f(glGetUniformLocation(shader1.ID, "light.diffuse"), 0.8f, 0.8f, 0.8f);
		glUniform3f(glGetUniformLocation(shader1.ID, "light.specular"), 1.0f, 1.0f, 1.0f);
		glUniform1f(glGetUniformLocation(shader1.ID, "light.constant"), 1.0f);
		glUniform1f(glGetUniformLocation(shader1.ID, "light.linear"), 0.09f);
		glUniform1f(glGetUniformLocation(shader1.ID, "light.quadratic"), 0.032f);
		glUniform1f(glGetUniformLocation(shader1.ID, "material.shininess"), 32.0f);
