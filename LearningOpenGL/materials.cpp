...
void materials()
{
	...
	Shader shader1("materials.vert", "materials.frag");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glUniform3fv(glGetUniformLocation(shader1.ID, "light.ambient"), 1, &ambientColor[0]);
		glUniform3fv(glGetUniformLocation(shader1.ID, "light.diffuse"), 1, &diffuseColor[0]);
		glUniform3f(glGetUniformLocation(shader1.ID, "light.specular"), 1.0f, 1.0f, 1.0f);
		glUniform3f(glGetUniformLocation(shader1.ID, "material.ambient"), 1.0f, 0.5f, 0.31f);
		glUniform3f(glGetUniformLocation(shader1.ID, "material.diffuse"), 1.0f, 0.5f, 0.31f);
		glUniform3f(glGetUniformLocation(shader1.ID, "material.specular"), 0.5f, 0.5f, 0.5f);
