...
void normal_mapping()
{
	...
	unsigned char *data = stbi_load("resources/textures/brickwall.jpg", &width, &height, &nrComponents, 0);
	GLenum format;
	if (nrComponents == 1)
		format = GL_RED;
	...
	data = stbi_load("resources/textures/brickwall_normal.jpg", &width, &height, &nrComponents, 0);
	if (nrComponents == 1)
		format = GL_RED;
	else if (nrComponents == 3)
		format = GL_RGB;
